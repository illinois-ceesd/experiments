...
Point(17)  = {-rad_out, -y, 0.0, lcar1};
Point(18)  = { rad_out, -y, 0.0, lcar1};
//Finer mesh around corners

//Point(19)  = {-rad_out-0.01, -y+0.02, 0.0, lcar4};
//Point(20)  = { rad_out+0.01, -y+0.02, 0.0, lcar4};
